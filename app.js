...
async function sendToServer(
    ...
    if (response.status === 404) {
        ...
        sessionId =
            await createSession(conversation);
    ...
    welcome.innerHTML = `
        <div class="welcome-hero">
            ...
            <p class="welcome-subtitle">
                Ask Beam a question, work through
                an idea, write something, or just
        ...
        <div class="suggestions">
            ...
            <button
                class="suggestion"
                data-prompt="Explain something interesting to me."
            >
                <span class="suggestion-icon">✦</span>
                <strong>Explain something</strong>
                <span>
                    Break down a topic in a simple way.
                </span>
            </button>

            <button
                class="suggestion"
                data-prompt="Help me solve a problem."
            >
                <span class="suggestion-icon">⌁</span>
            ...
            <button
                class="suggestion"
                data-prompt="Give me an interesting idea for a project."
            >
                <span class="suggestion-icon">◇</span>
            ...
            <button
                class="suggestion"
                data-prompt="Hey Beam, how are you?"
            >
                <span class="suggestion-icon">◌</span>
    ...
    if (type === "policy") {
        modalContent.innerHTML = `
            <div class="modal-content">
                ...
                <p>
                    Beam is an experimental AI
                    project. Responses can be
                    incorrect, incomplete, outdated,
                    or misleading.
                </p>

                <p>
                    Do not rely on Beam for medical,
                    legal, financial, emergency,
                    or other high-stakes decisions.
                </p>

                <p>
                    This public beta is operated
                    through a personally hosted
                    Beam server. Availability,
                    performance, session persistence,
                    and response quality may change
                    without notice.
                </p>
...
mobileModelButton.addEventListener(
    "click",
    event => {
        event.stopPropagation();
