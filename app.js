    ...
    welcome.innerHTML = `
        <div class="welcome-hero">
            ...
            <p class="welcome-subtitle">
                Ask Beam a question, work through an idea, write something,
...
function exportConversation() {
    ...
    link.href = url;
    link.download =
        `${conversation.title.replace(/[\\/:*?"<>|]/g, "_")}.txt`;
    ...
    if (type === "policy") {
        modalContent.innerHTML = `
            <div class="modal-content">
                ...
                <p>
                    Beam is an experimental AI project. Responses can be
                    incorrect, incomplete, outdated, or misleading.
                </p>

                <p>
                    Do not rely on Beam for medical, legal, financial,
                    emergency, or other high-stakes decisions.
                </p>

                <p>
                    This public beta is operated through a personally
                    hosted Beam server. Availability, performance,
                    session persistence, and response quality may change
                    without notice.
                </p>

                <p>
                    The Beam system uses an underlying open-weight language
                    model. Beam's interface, server, personality, session
                    management, and surrounding software are part of the
                    Beam project.
                </p>
            </div>
        `;
